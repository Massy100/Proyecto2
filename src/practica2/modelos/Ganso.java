...
public class Ganso extends Animal{
    ...
    public Ganso(double Precio, int tiempoMorirVejez, int cantidadComer, int tiempoCrecer, int cantidadEspacio, boolean Destazable, String Tipo, int Edad, int Carne, int tiempoMorirHambre, int recibirCarinio, String Especie, boolean Vivo) {
